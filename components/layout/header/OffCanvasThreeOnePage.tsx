...
const OffCanvasThreeOnePage = ({ toggleMenu, handleToggleMenu }: any) => {
    ...
    >
      ...
      <div className="mobile-menu overflow-hidden">
        <nav className="mean-nav">
          <ul>
            ...
            <li>
              <Link href="#about-three" onClick={() => handleToggleMenu(false)}>
                About
              </Link>
            </li>
            <li>
              <Link href="#case-three" onClick={() => handleToggleMenu(false)}>
                Case
              </Link>
            </li>
            <li>
      ...
      <ul className="info pt-40">
        ...
        <li className="py-2">
          ...
          <Link href="tel:+880 1715-384539">+880 1715-384539</Link>
        </li>
        <li>
          <i className="fa-solid primary-color fa-paper-plane"></i>{" "}
          <Link href="/">helpline@leavesoft.com</Link>
        </li>
      </ul>
...
export default OffCanvasThreeOnePage;
